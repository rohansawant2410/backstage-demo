...
Fork the following repo `https://github.com/rohansawant2410/backstage-demo` to your organization.
...
cd backstage-demo
find . -type f -not -path '*/\.git/*' -exec sed -i "s/rohansawant2410/${github_organization}/g" {} +
find . -type f -not -path '*/\.git/*' -exec sed -i "s/rohansawant2410/${github_organization}/g" {} +
...
Fork the following repo `https://github.com/rohansawant2410/shared-workflows` to your organization.
Then execute the following commands
...
Fork the following repo `https://github.com/rohansawant2410/software-templates` to your organization.
Then execute the following commands
...
Fork the following repo `https://github.com/rohansawant2410/backstage-app-demo` to your organization.
